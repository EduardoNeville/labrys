...
BENNETT_TO_UNICODE: list[tuple[str, str, str, str, str]] = [
    ...
    ("A 301", "U+10655", "𐙕", "", "syllabogram"),
    ("A 302", "U+10656", "𐙖", "", "syllabogram"),
    ("A 303", "U+10657", "𐙗", "", "syllabogram"),
    ("A 304", "U+10658", "𐙘", "", "syllabogram"),
    ("A 305", "U+10659", "𐙙", "", "syllabogram"),
    ("A 306", "U+1065A", "𐙚", "", "syllabogram"),
    ("A 307", "U+1065B", "𐙛", "", "syllabogram"),
    ("A 308", "U+1065C", "𐙜", "", "syllabogram"),
    ("A 309A", "U+1065D", "𐙝", "", "syllabogram"),
    ("A 309B", "U+1065E", "𐙞", "", "syllabogram"),
    ("A 309C", "U+1065F", "𐙟", "", "syllabogram"),
    ("A 310", "U+10660", "𐙠", "", "syllabogram"),
    ("A 311", "U+10661", "𐙡", "", "syllabogram"),
    ("A 312", "U+10662", "𐙢", "", "syllabogram"),
    ("A 313A", "U+10663", "𐙣", "", "syllabogram"),
    ("A 313B", "U+10664", "𐙤", "", "syllabogram"),
    ("A 313C", "U+10665", "𐙥", "", "syllabogram"),
    ("A 314", "U+10666", "𐙦", "", "syllabogram"),
    ("A 315", "U+10667", "𐙧", "", "syllabogram"),
    ("A 316", "U+10668", "𐙨", "", "syllabogram"),
    ("A 317", "U+10669", "𐙩", "", "syllabogram"),
    ("A 318", "U+1066A", "𐙪", "", "syllabogram"),
    ("A 319", "U+1066B", "𐙫", "", "syllabogram"),
    ("A 320", "U+1066C", "𐙬", "", "syllabogram"),
    ("A 321", "U+1066D", "𐙭", "", "syllabogram"),
    ("A 322", "U+1066E", "𐙮", "", "syllabogram"),
    ("A 323", "U+1066F", "𐙯", "", "syllabogram"),
    ("A 324", "U+10670", "𐙰", "", "syllabogram"),
    ("A 325", "U+10671", "𐙱", "", "syllabogram"),
    ("A 326", "U+10672", "𐙲", "", "syllabogram"),
    ("A 327", "U+10673", "𐙳", "", "syllabogram"),
    ("A 328", "U+10674", "𐙴", "", "syllabogram"),
    ("A 329", "U+10675", "𐙵", "", "syllabogram"),
    ("A 330", "U+10676", "𐙶", "", "syllabogram"),
    ("A 331", "U+10677", "𐙷", "", "syllabogram"),
    ("A 332", "U+10678", "𐙸", "", "syllabogram"),
    ("A 333", "U+10679", "𐙹", "", "syllabogram"),
    ("A 334", "U+1067A", "𐙺", "", "syllabogram"),
    ("A 335", "U+1067B", "𐙻", "", "syllabogram"),
    ("A 336", "U+1067C", "𐙼", "", "syllabogram"),
    ("A 337", "U+1067D", "𐙽", "", "syllabogram"),
    ("A 338", "U+1067E", "𐙾", "", "syllabogram"),
    ("A 339", "U+1067F", "𐙿", "", "syllabogram"),
    ("A 340", "U+10680", "𐚀", "", "syllabogram"),
    ("A 341", "U+10681", "𐚁", "", "syllabogram"),
    ("A 342", "U+10682", "𐚂", "", "syllabogram"),
    ("A 343", "U+10683", "𐚃", "", "syllabogram"),
    ("A 344", "U+10684", "𐚄", "", "syllabogram"),
    ("A 345", "U+10685", "𐚅", "", "syllabogram"),
    ("A 346", "U+10686", "𐚆", "", "syllabogram"),
    ("A 347", "U+10687", "𐚇", "", "syllabogram"),
    ("A 348", "U+10688", "𐚈", "", "syllabogram"),
    ("A 349", "U+10689", "𐚉", "", "syllabogram"),
    ("A 350", "U+1068A", "𐚊", "", "syllabogram"),
    ("A 351", "U+1068B", "𐚋", "", "syllabogram"),
    ("A 352", "U+1068C", "𐚌", "", "syllabogram"),
    ("A 353", "U+1068D", "𐚍", "", "syllabogram"),
    ("A 354", "U+1068E", "𐚎", "", "syllabogram"),
    ("A 355", "U+1068F", "𐚏", "", "syllabogram"),
    ("A 356", "U+10690", "𐚐", "", "syllabogram"),
    ("A 357", "U+10691", "𐚑", "", "syllabogram"),
    ("A 358", "U+10692", "𐚒", "", "syllabogram"),
    ("A 359", "U+10693", "𐚓", "", "syllabogram"),
    ("A 360", "U+10694", "𐚔", "", "syllabogram"),
    ("A 361", "U+10695", "𐚕", "", "syllabogram"),
    ("A 362", "U+10696", "𐚖", "", "syllabogram"),
    ("A 363", "U+10697", "𐚗", "", "syllabogram"),
    ("A 364", "U+10698", "𐚘", "", "syllabogram"),
    ("A 365", "U+10699", "𐚙", "", "syllabogram"),
    ("A 366", "U+1069A", "𐚚", "", "syllabogram"),
    ("A 367", "U+1069B", "𐚛", "", "syllabogram"),
    ("A 368", "U+1069C", "𐚜", "", "syllabogram"),
    ("A 369", "U+1069D", "𐚝", "", "syllabogram"),
    ("A 370", "U+1069E", "𐚞", "", "syllabogram"),
    ("A 371", "U+1069F", "𐚟", "", "syllabogram"),
]
